        ...
        <div class="col-md-6 col-md-offset-3">
            <div class="panel panel-note">
                ...
                <div class="panel-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <form id="note-form" action="/notes/submNote" method="post" role="form" style="display: block;">
                                    ...
                                    <div class="importance">
                                        ...
                                        <#list importances as importance>
                                            <label class="importance">
                                                <input type="radio" name="importance" value="${importance}" ${importance.normal?string("checked", "")}>${importance.translation}
                                            </label>
                                        </#list>
                                    </div>
                                </div>
